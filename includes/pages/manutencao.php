...
$query = $pdo->prepare("select * from $tb_user where usuario = ?");
$query->execute([$user]);
$retorno = $query->fetch();
?>
    ...
    <body>
        ...
        <div class="container">
            <div class="box">
                ...
                <h1>Em manutenção!</h1>
                <p>Site em manutenção, retorne quando o processo estiver concluido.</p>

            </div>
            <?php
            if ($retorno['su'] == 10) {

                echo '<a href="../../admin/painel" class="index-erro">' . $_SESSION['usuario'] . ' - Clique para acessar o Painel</a>';
            }
            ?>
        </div>
